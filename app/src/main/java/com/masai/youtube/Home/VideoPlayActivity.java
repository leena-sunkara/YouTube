...
public class VideoPlayActivity extends AppCompatActivity implements ItemClickListener{
    ...
    private void dataSet() {
        for (int i = 0; i < 20; i++) {
            arraylist2.add(new Model("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/c9v8MzV6PVU\" frameborder=\"0\" allowfullscreen></iframe>", R.drawable.masiaicon, "Masai School - Education loans vs Coding Career", "11,201,181 views . Feb 2, 2021", R.drawable.masai,"Masai School","12.7K subscribers"));
            ...
            arraylist2.add(new Model("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/8yHSAtQ73_8\" frameborder=\"0\" allowfullscreen></iframe>", R.drawable.masiaicon, "Know your Resume and Portfolio #Shorts #Masai", "1,052 views . Sep 23, 2021", R.drawable.masai,"Masai School","12.7K subscribers"));
